...
create table foo (id bigint not null auto_increment, primary key (id)) engine=InnoDB;
...
create table publisher (id bigint not null auto_increment, address varchar(255), name varchar(255), primary key (id)) engine=InnoDB;
