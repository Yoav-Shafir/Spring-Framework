...
import com.springframework.springframework.features.recipe.Difficulty;
import com.springframework.springframework.features.recipe.Recipe;
import com.springframework.springframework.features.recipe.RecipeRepository;
...
@Component
// This profile will pick the `application-default.properties` configuration file.
// This profile uses the h2 database.
@Profile("default")
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        // Create a list for 2 new Recipes.
        List<Recipe> recipes = new ArrayList<>(2);

        // Get all UnityOfMeasure we have in db.
